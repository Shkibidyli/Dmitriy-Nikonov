...
# Главное окно
window = tk.Tk()
window.title("Дневник погоды Weather Diary")
...
input_frame = ttk.LabelFrame(window, text="Новая запись", padding=(10, 5))
...
# Рамка 2: Фильтры
filter_frame = ttk.LabelFrame(window, text="Фильтр", padding=(10, 5))
...
ttk.Button(filter_frame, text="Применить", command=apply_filter).grid(row=2, columnspan=2, pady=(5), ipadx=35)
